...
PATH_TERM2ID = "/home/jraad/ssd/data/identity-data/term2id_original.csv"
...
with open(PATH_TERM2ID) as f:
    ...
    while line:
        ...
        insertToDB(splitted_line[0], splitted_line[1], DB_TERM_2_ID_original)
print("Finished creating database (TERM to ID original). There is a total of ", "{:,}".format(cnt), "terms")
